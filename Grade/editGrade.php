                        ...
                        <?php
                            ...
                            <form action="calculate.php" method="get">
                                <tr>
                                    ...
                                    <input type="text" value="<?= stripslashes($info->matric) ?>" name="id" hidden>
                                    <input type="text" value="<?= $class_id ?>" name="class_id" hidden>
                                    <td><input type="number" style="width:70px;" value="<?= $info->quiz1 ?>" name="q1" min="0" max="5" step=".01"></td>
                                    <td><input type="number" style="width:70px;" value="<?= $info->quiz2 ?>" name="q2" min="0" max="5" step=".01"></td>
                                    <td><input type="number" style="width:130px;" value="<?= $info->assignment ?>" name="assignment" min="0" max="15" step=".01">
                                    </td>
                                    <td><input type="number" style="width:90px;" value="<?= $info->project ?>" name="project" min="0" max="25" step=".01">
                                    </td>
                                    <td><input type="number" style="width:70px;" value="<?= $info->final ?>" name="final" min="0" max="40" step=".01"></td>
                                    <td><input type="number" style="width:130px;" value="<?= $info->attendance ?>" name="attendance" min="0" max="10" step=".01">
                                    </td>
                                    ...
                                    <?php } else { ?>
                                        <td><?= $info->grade ?></td>
                                    <?php } ?>
                                    <td><button type="submit" class="btn btn-rounded btn-primary btn-sm" name="save">Save<i class="fa fa-save pl-1"></i></button>
                                        <a role="button" href="grade.php?section=<?= $section ?>" class="btn btn-rounded btn-primary btn-sm">Cancel<i class="fa fa-ban pl-1"></i></a>
                                    </td>
                                </tr>
                            </form>
                        <?php } else { ?>
                            <tr>
                                <td><?= stripslashes($info->matric) ?></td>
                                <td><?= stripslashes($info->name) ?></td>
                                <td><input type="number" style="width:70px;" value="<?= $info->quiz1 ?>" disabled></td>
                                <td><input type="number" style="width:70px;" value="<?= $info->quiz2 ?>" disabled></td>
                                <td><input type="number" style="width:130px;" value="<?= $info->assignment ?>" disabled></td>
                                <td><input type="number" style="width:90px;" value="<?= $info->project ?>" disabled>
                                </td>
                                <td><input type="number" style="width:70px;" value="<?= $info->final ?>" disabled></td>
                                <td><input type="number" style="width:130px;" value="<?= $info->attendance ?>" disabled></td>
                                <?php if ($info->total < 40) { ?>
                                    <td style="color:red;"><?= $info->total ?></td>
                                <?php } else { ?>
                                    <td><?= $info->total ?></td>
                                ...
                                <?php } else { ?>
                                    <td><?= $info->grade ?></td>
                                <?php } ?>
                                <td><a role="button" href="editGrade.php?matric=<?= $info->matric ?>&section=<?= $section ?>" class="btn btn-rounded btn-primary btn-sm">Edit&nbsp<i class="fa fa-edit pl-1"></i></a>
