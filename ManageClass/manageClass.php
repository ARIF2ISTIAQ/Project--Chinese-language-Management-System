...
<body>
    ...
    <div id="main" class="container" style="min-height: 500px;">
        ...
        <div align="right">
            <a role="button" href="addclass.php" class="btn btn-rounded btn-primary">Create
                Class</a>
        </div>
        <br>
        <?php
        ...
        <table class='table table-bordered' id='myTable' style='width:100%;'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $available ?>/25</td>
                    <td><?= $row['status'] ?></td>
                    <td><a role="button" href="view.php?section=<?= $row['section'] ?>"
                            class="btn btn-rounded btn-primary btn-sm">View</a>
                        <a role="button" href="edit.php?section=<?= $row['section'] ?>"
                            class="btn btn-rounded btn-primary btn-sm">Edit</a>
                        <a role="button" href="delete.php?section=<?= $row['section'] ?>"
