    ...
    <div id="main" class="container">
        ...
        <form action="" method="post">
            ...
            <div class="row" style="margin-left: 0;">
                <input class="form-control" style="width: 150px; margin-right:10px;" type="text" name="name"
                    placeholder="Name">
                <input type="submit" class="btn btn-primary" name="sname" value="Search Name">
                <input class="form-control" style="width: 150px; margin-right:10px;margin-left:10px;" type="text"
                    name="matric" placeholder="Matric">
                <input type="submit" class="btn btn-primary" name="smatric" value="Search Matric">
                <a href="addAdmin.php" class="btn btn-primary" style="right: 125px; position:absolute;">Add New
                    Admin</a>
            </div>
        </form>
            ...
            <table class="table">
                ...
                if (isset($_POST["sname"])) {
                    ...
                    if ($conn->connect_error) {
                        ...
                        $sql = "SELECT * FROM admin WHERE name LIKE '%$search_value%' ORDER BY name ASC";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a role="button" href="editAdmin.php?username=<?= $row['username'] ?>"
                                class="btn btn-rounded btn-primary btn-sm">Edit</a>
                            <a role="button" href="deleteAdmin.php?username=<?= $row['username'] ?>"
                    ...
                    <?php $num++;
                        ...
                        if ($conn->connect_error) {
                            ...
                            $sql = "SELECT * FROM admin WHERE matric LIKE '%$search_value%' ORDER BY name ASC";
