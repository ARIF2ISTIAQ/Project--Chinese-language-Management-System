                    ...
                    while ($row = $res->fetch_assoc()) { ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="course" class="form-control">
                                <?php if ($row["course"] == "Mandarin Level 1") { ?>
                                ...
                                <?php
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($rowC = $result->fetch_assoc()) {
                                                if ($rowC['section'] == $row['section']) {
                                                    ?>
                                            <option value=" <?= $rowC['section'] ?>" selected><?= $rowC['section'] ?></option>
                                        <?php } else { ?>
                                            <option value=" <?= $rowC['section'] ?>"><?= $rowC['section'] ?></option>
                                <?php
                                                }
                                            }
                                        }
