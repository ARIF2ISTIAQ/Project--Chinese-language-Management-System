        ...
        <div style="min-height:350px;">
            <table>
                <tr>
                    ...
                    <td>
                        <a href="admin.php" class="btn btn-link btn-lg" style="margin-bottom: 7px;">Administrator</a>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <a href="student.php" class="btn btn-link btn-lg" style="margin-bottom: 7px;">Student</a>
                    </td>
                </tr>
            </table>
