    ...
    <div id="main" class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <h1 class="my-4"><img src="../images/logo.png" style="width:10%;height:10%;">Create
                    <small>NEWS</small>
                </h1>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form name="form1" method="post" action="Create.php" enctype="multipart/form-data">
                            <h4>Title</h4>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" style="height:300px">
                        ...
                        <textarea class="form-control" row="5" style="height:200px" name="description" required></textarea>
                    </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" style="height:300px">
                        <h4>Full Content</h4>
                        <textarea class="form-control" row="5" style="height:200px" name="content" required></textarea>
                    </div>
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            <h6>Rules need to take note!!!</h6>
                            <ul>
                                <li>Title field cannot be empty</li>
                                <li>Content field cannot be empty</li>
                                <li>Image upload must in "png", "jpg", "jpeg", & "gif" type</li>
                            </ul>
                        </div>
                    </div>
                </div>
