    ...
    <div id="main" class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <h1 class="my-4"><img src="../images/logo.png" style="width:10%;height:10%;">Delete
                    <small>NEWS</small>
                </h1>
                ...
                <div class="col-lg-8">
                    ...
                    <?php if ($news && !empty($news)) : ?>
                        ...
                        <?php foreach ($news as $key => $article) : ?>
                            ...
                            <h4 style="text-align:right;"><a style="color:rgb(0, 0, 102);" href="Delete.php?newsid=<?= $article->news_id ?>" onclick="return  confirm('Are you sure want to delete?\nIt cannot recover once deleted!')">Delete</a>
                            </h4>
                            <hr>
                        <?php endforeach ?>
            ...
            <div class="col-md-4">
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body">
                        <div class="input-group">
                            <ul>
                                <li>Make sure the news selected correctly</li>
                                <li>Once deleted, it cannot be restore</li>
                            </ul>
                        </div>
                    </div>
                </div>
